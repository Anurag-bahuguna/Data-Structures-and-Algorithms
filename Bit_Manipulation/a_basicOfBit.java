...
public class bit_1 {
    ...
    // Bit Manipulation  . it mostly use left and right shift operator
      //1. Get bit
        // steps 1 bit mask like 1<< i
        //       2 operation like add 
        //       if AND output is non-zero then it is '1' and 
        //       if AND output is zero then it is '0'
     ...
     //3. Clear bit  ( means make it '0')
      ...
      //4. Update bit
        ...
        //       
        // note: index is start from right side.
        //Q. Update the 2rd bit (position = 1) of a number n to 1 . (n = 0101)
        ...
        if (operation == 1) {
            int newNumber = bitMask | n ;   //set
            System.out.println(newNumber);
        } else {
            int NOT_bitMask = ~ (bitMask);
            int newNumber = NOT_bitMask & n ;   //Clear
            System.out.println(newNumber);
        }
